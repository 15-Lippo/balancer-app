...
${En`
  ...
  users(
    ...
    ${Bn}`,Yn=(e,t,a)=>e();function Jn(e,t=Yn){return{PoolShare:(a,n)=>t((t=>e.request(Dn,a,{...n,...t})),"PoolShare","query"),PoolShares:(a,n)=>t((t=>e.request(Cn,a,{...n,...t})),"PoolShares","query"),Pools:(a,n)=>t((t=>e.request(Rn,a,{...n,...t})),"Pools","query"),AllPools:(a,n)=>t((t=>e.request(Mn,a,{...n,...t})),"AllPools","query"),Pool:(a,n)=>t((t=>e.request(Fn,a,{...n,...t})),"Pool","query"),PoolsWithoutLinear:(a,n)=>t((t=>e.request(Ln,a,{...n,...t})),"PoolsWithoutLinear","query"),PoolWithoutLinear:(a,n)=>t((t=>e.request(Un,a,{...n,...t})),"PoolWithoutLinear","query"),PoolHistoricalLiquidities:(a,n)=>t((t=>e.request($n,a,{...n,...t})),"PoolHistoricalLiquidities","query"),PoolSnapshots:(a,n)=>t((t=>e.request(Gn,a,{...n,...t})),"PoolSnapshots","query"),JoinExits:(a,n)=>t((t=>e.request(qn,a,{...n,...t})),"JoinExits","query"),Balancers:(a,n)=>t((t=>e.request(Wn,a,{...n,...t})),"Balancers","query"),TokenPrices:(a,n)=>t((t=>e.request(Vn,a,{...n,...t})),"TokenPrices","query"),TokenLatestPrices:(a,n)=>t((t=>e.request(Hn,a,{...n,...t})),"TokenLatestPrices","query"),TokenLatestPrice:(a,n)=>t((t=>e.request(jn,a,{...n,...t})),"TokenLatestPrice","query"),User:(a,n)=>t((t=>e.request(Kn,a,{...n,...t})),"User","query"),Users:(a,n)=>t((t=>e.request(Xn,a,{...n,...t})),"Users","query")}}var Zn,zn,Qn,es,ts,as,ns,ss,is,rs,os,ds,cs,ls,ps;!function(e){e.Arbitrum="Arbitrum",e.Optimism="Optimism",e.Polygon="Polygon"}(Zn||(Zn={})),function(e){e.Gauges="gauges",e.Id="id",e.NumGauges="numGauges"}(zn||(zn={})),function(e){e.Balance="balance",e.Gauge="gauge",e.Id="id",e.User="user"}(Qn||(Qn={})),function(e){e.Id="id",e.Name="name"}(es||(es={})),function(e){e.Gauge="gauge",e.Id="id",e.Timestamp="timestamp",e.User="user",e.Weight="weight"}(ts||(ts={})),function(e){e.AddedTimestamp="addedTimestamp",e.Address="address",e.Id="id",e.LiquidityGauge="liquidityGauge",e.RootGauge="rootGauge",e.Type="type"}(as||(as={})),function(e){e.Factory="factory",e.Gauge="gauge",e.Id="id",e.IsKilled="isKilled",e.IsPreferentialGauge="isPreferentialGauge",e.Pool="pool",e.PoolAddress="poolAddress",e.PoolId="poolId",e.RelativeWeightCap="relativeWeightCap",e.Shares="shares",e.Streamer="streamer",e.Symbol="symbol",e.Tokens="tokens",e.TotalSupply="totalSupply"}(ns||(ns={})),function(e){e.Asc="asc",e.Desc="desc"}(ss||(ss={})),function(e){e.Address="address",e.Gauges="gauges",e.GaugesList="gaugesList",e.Id="id",e.PoolId="poolId",e.PreferentialGauge="preferentialGauge"}(is||(is={})),function(e){e.Decimals="decimals",e.Gauge="gauge",e.Id="id",e.PeriodFinish="periodFinish",e.Rate="rate",e.Symbol="symbol",e.TotalDeposited="totalDeposited"}(rs||(rs={})),function(e){e.Chain="chain",e.Factory="factory",e.Gauge="gauge",e.Id="id",e.IsKilled="isKilled",e.Recipient="recipient",e.RelativeWeightCap="relativeWeightCap"}(os||(os={})),function(e){e.GaugeShares="gaugeShares",e.GaugeVotes="gaugeVotes",e.Id="id",e.VotingLocks="votingLocks"}(ds||(ds={})),function(e){e.Id="id",e.LockedBalance="lockedBalance",e.UnlockTime="unlockTime",e.UpdatedAt="updatedAt",e.User="user",e.VotingEscrowId="votingEscrowID"}(cs||(cs={})),function(e){e.Id="id",e.Locks="locks",e.StakedSupply="stakedSupply"}(ls||(ls={})),function(e){e.Allow="allow",e.Deny="deny"}(ps||(ps={}));const us=En`
